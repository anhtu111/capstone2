...
export default function MuscleBody() {
  ...
  const [videos, setVideos] = useState({
    ...
    biceps: "avc0CYyUTmM",
    triceps: "j9jF_IiDSVg",
    trapezius: "CVbuDPnjyHw",
    lats: "69XcCHhedDE",
    abs: "bCsXtr4lemc",
    obliques: "rFQyFnohjrs",
    pectorals: "KMDJJJQ9o6c",
    adductors: "xuvp4ID_bXM",
    calves: "ZYHw4zgzTec",
    hamstrings: "BV5g0v77v1w",
    glutes: "LzDxZmJ2Lpw",
    quads: "QE__edG6uSQ",
  });
    ...
    <div className="muscle-body">
      ...
      <main>
        ...
        <div className="muscle-groups">
          <h1>HƯỚNG DẪN TẬP CÁC NHÓM CƠ</h1>
          <h2 style={{ paddingTop: "50px" }}>TAY</h2>
          <input
            type="checkbox"
            className="biceps muscles-helper"
            id="biceps"
          />
          <label htmlFor="biceps" onClick={() => handleLabelClick("biceps")}>
            Bắp tay
          </label>
          <input
            type="checkbox"
          ...
          <label
            htmlFor="deltoids"
            onClick={() => handleLabelClick("deltoids")}
          >
            Cơ vai
          </label>
          <input
          ...
          <label
            htmlFor="forearms"
            onClick={() => handleLabelClick("forearms")}
          >
            Cơ cẳng tay
          </label>
          <input
            ...
            id="triceps"
          />
          <label htmlFor="triceps" onClick={() => handleLabelClick("triceps")}>
            Tay sau
          </label>
          <h2>LƯNG</h2>
          <input
          ...
          <label
            htmlFor="trapezius"
            onClick={() => handleLabelClick("trapezius")}
          >
            Cơ lưng (trên)
          </label>
          <input type="checkbox" className="lats muscles-helper" id="lats" />
          <label htmlFor="lats" onClick={() => handleLabelClick("lats")}>
            Cơ vai sau
          </label>
          <h2>BỤNG</h2>
          <input type="checkbox" className="abs muscles-helper" id="abs" />
          <label htmlFor="abs" onClick={() => handleLabelClick("abs")}>
            Cơ bụng
          </label>
          <input
            type="checkbox"
          ...
          <label
            htmlFor="obliques"
            onClick={() => handleLabelClick("obliques")}
          >
            Cơ liên sườn
          </label>
          <input
          ...
          <label
            htmlFor="pectorals"
            onClick={() => handleLabelClick("pectorals")}
          >
            Ngực
          </label>
          <h2>CHÂN</h2>
          ...
          <label
            htmlFor="adductors"
            onClick={() => handleLabelClick("adductors")}
          >
            Cơ khép
          </label>
          <input
            ...
            id="calves"
          />
          <label htmlFor="calves" onClick={() => handleLabelClick("calves")}>
            Cơ bắp chân
          </label>
          <input
            type="checkbox"
          ...
          <label
            htmlFor="hamstrings"
            onClick={() => handleLabelClick("hamstrings")}
          >
            Cơ đùi sau
          </label>
          <input
            ...
            id="glutes"
          />
          <label htmlFor="glutes" onClick={() => handleLabelClick("glutes")}>
            Cơ mông
          </label>
          <input type="checkbox" className="quads muscles-helper" id="quads" />
          <label htmlFor="quads" onClick={() => handleLabelClick("quads")}>
            Cơ đùi trước
          </label>
